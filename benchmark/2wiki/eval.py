...
async def evaluate(
    ...
    # Index the document
    document_path = f"benchmark/2wiki/2wiki_corpus_100.txt"
    content_type = "text/plain"
    document_meta = {
        "type": "txt",
        "filename": "2wiki_corpus_100.txt",
        "uri": document_path,
        "private": False,
    }
...
if __name__ == "__main__":
    ...
    asyncio.run(
        evaluate(
            ...
            n_questions=10,  # Adjust as needed
            max_concurrent=3,  # Adjust based on your system capacity
        )
    )
